<template>
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" @sort-change="handleSortChange">
      ...
      <el-table-column label="操作人员" align="center" prop="createAt" width="100" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']" />
    ...
    <el-dialog title="操作日志详细" :visible.sync="open" width="700px" append-to-body>
      <el-form ref="form" :model="form" label-width="100px" size="mini">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="操作人：">{{ form.createAt }}</el-form-item>
          </el-col>
          <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    resetQuery() {
      ...
      this.queryParams.order = 'id-desc';
      this.handleQuery();
    },
    /** 多选框选中数据 */
    ...
    handleSortChange(column, prop, order) {
      this.queryParams.order = column.prop+"-"+(column.order ==='ascending' ? "asc" : 'desc');
      this.getList();
    },
    /** 详细按钮操作 */
    handleView(row) {
